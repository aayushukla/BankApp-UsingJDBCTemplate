		...
		try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
			while (true) {
				...
				case 4:
					...
					} catch (LowBalanceException | BankAccountNotFoundException | EmptyResultDataAccessException e) {		System.out.println("exception in client");
						e.printStackTrace();
					}
				...
				case 8:
					System.out.println("Enter account Id:");
					accountId = Long.parseLong(reader.readLine());
					System.out.println("Account Balance:"+bankService.checkBalance(accountId));
				...
				case 9:
					...
					accountType = reader.readLine();
					System.out.println("Your account details are updated.."+bankService.updateBankAccount(accountId, accountHolderName, accountType));
